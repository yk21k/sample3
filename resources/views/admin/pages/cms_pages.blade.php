                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        &nbsp;&nbsp;
                        <a style='color:#078aed;' class="confirmDelete" name="CMS Page" title="Delete CMS Page" href="javascript:void(0)" record="cms-page" recordid="{{ $page['id'] }}" ><i class="fas fa-trash"></i></a>  
                      </td>
                    </tr>
                    @endforeach 
                  </tbody>
